...
public interface IOrderService {
    ...
    Page<OrderResponse> getMyOrders(Long userId, OrderFilterRequest request, Pageable pageable);
    OrderResponse getMyOrderById(Long userId, Long orderId);
    OrderResponse cancelMyOrder(User user, Long orderId);

    Page<OrderAdminResponse> getAllOrders(OrderFilterRequest request, Pageable pageable);
