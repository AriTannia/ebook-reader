...
public class AuthMessage {
    ...
    public static final String PASSWORD_RESET_TOKEN_EXPIRED = "Password reset token was expired. Please make a new request";
    ...
    public static final String PASSWORD_CHANGED_SUCCESSFULLY = "Change password successfully";
    ...
    public static final String PASSWORD_RESET_TOKEN_NOT_FOUND = "Password reset token not found";
}
